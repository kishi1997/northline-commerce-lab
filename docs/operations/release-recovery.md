...
6. Create a signed/annotated `v1.0.0` tag after the PR is merged.
7. Attach the two custom ZIP files and Blueprint JSON from `playground/dist` to the GitHub Release.
